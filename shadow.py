...
if HARDWARD_CONFIGURED:
    from runLED import setup, turn_on, turn_off, destroy
...
parser.add_argument('--endpoint a3lkr6zt4aa9z1-ats.iot.us-east-1.amazonaws.com', required=True, help="Your AWS IoT custom endpoint, not including a port. " +
                                                      "Ex: \"w6zbse3vjd5b4p-ats.iot.us-west-2.amazonaws.com\"")
parser.add_argument('--cert /home/pi/Documents/Coffee/A-Coffee-Problem/connect_device_package/coffee_station.cert.pem',  help="File path to your client certificate, in PEM format")
parser.add_argument('--key /home/pi/Documents/Coffee/A-Coffee-Problem/connect_device_package/coffee_station.private.key', help="File path to your private key file, in PEM format")
parser.add_argument('--root-ca /home/pi/Documents/Coffee/A-Coffee-Problem/connect_device_package/AmazonRootCA1.pem', help="File path to root certificate authority, in PEM format. " +
